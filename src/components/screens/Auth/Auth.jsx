	...
	return (
		<div className={s.login}>
			...
			<form className={s.form} onSubmit={handleSubmit}>
				...
				<div
					className={s.form__btn_add}
					onClick={() => setType(isAuthType ? 'register' : 'login')}
				>
					{isAuthType ? 'Register' : 'Login'}?
				</div>
			</form>
		</div>
	)
